...
from rescomp import version as rescomp_version
...
latex_documents = [
  (master_doc, 'ResComp.tex', u'ResComp Documentation',
...
man_pages = [
    (master_doc, 'rescomp', u'ResComp Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ResComp', u'ResComp Documentation',
   author, 'ResComp', 'One line description of project.',
   'Miscellaneous'),
]
